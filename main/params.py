"""
Adapted from open_clip: https://github.com/mlfoundations/open_clip/blob/main/src/training/params.py
"""
...
def parse_args(args):
    ...
    parser.add_argument(
        "--linear_probe_num_epochs", type=int, default=32, help="Number of epochs to train for."
    )
    parser.add_argument(
        "--linear_probing",
        default=False,
        action="store_true",
        help="Whether to do linear probing.")
    parser.add_argument(
