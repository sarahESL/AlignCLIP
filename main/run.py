"""
Adapted from open_clip: https://github.com/mlfoundations/open_clip/blob/main/src/training/main.py
"""
...
from align_clip import create_model_and_transforms, trace_model, get_tokenizer, create_loss
from main.data import get_data
from main.distributed import is_master, init_distributed_device, broadcast_object
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if args.nl_semantic_supervision:
            train_one_epoch(model, data, loss, epoch, optimizer, scaler, scheduler, args, tb_writer=writer, sbert=sbert)
        else:
