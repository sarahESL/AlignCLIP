"""
Adapted from open_clip: https://github.com/mlfoundations/open_clip/blob/main/src/training/train.py
"""
...
from align_clip import get_input_dtype, CLIP
...
def train_one_epoch(model, data, loss, epoch, optimizer, scaler, scheduler, args, tb_writer=None, sbert=None):
